...
const Presentation = ({ title, event, location, date, url, text1, text2, text3 }) => {
  return (
    <div className="my-3">
      <div className="flex flex-row text-xl">
        <span className="text-gray-500 dark:text-gray-400">
          <Link href={url} className="title">
            {title}
          </Link>
        </span>{' '}
      ...
      <div>
        <div className="p-1 font-mono text-sm text-gray-400 dark:text-gray-600">{date}</div>
        <div className="p-2">
